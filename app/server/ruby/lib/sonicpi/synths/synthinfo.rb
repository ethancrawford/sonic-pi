      ...
      def specific_arg_info
        {
          ...
          :pan_start =>
          {
            :doc => "Starting position of sound in stereo. With headphones on, this means how much of the sound starts in the left ear, and how much starts in the right ear. With a value of -1, the sound starts completely in the left ear, a value of 0 starts the sound equally in both ears and a value of 1 starts the sound in the right ear. Values in between -1 and 1 move the sound accordingly.",
